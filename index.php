                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".oranges">Tomates</li>
                            <li data-filter=".fresh-meat">Carotte</li>
                            <li data-filter=".vegetables">Choux</li>
                            <li data-filter=".fastfood">Épinard</li>
                        </ul>
                    </div>
                </div>
            </div>
